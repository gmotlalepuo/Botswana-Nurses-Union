...
const messages: Record<string, string> = {
  ...
  "membership-payment-complete": "Monthly payment completed. Your membership is active.",
  ...
  "complaint-migration-required": "Complaints need database migration 012. Apply it in Supabase, then submit again.",
  ...
  "bundle-invalid": "Check the bundle provider, Botswana mobile number, monthly amount, term, activation day, and required consent boxes.",
  "subscription-amount": "Please enter a valid monthly subscription amount.",
  "membership-classification": "Select your citizenship status and employment sector.",
  "membership-consent": "Confirm the declaration before submitting your membership forms.",
  "membership-documents": "Upload all forms required for your employment sector.",
  "membership-file-invalid": "Membership uploads must be PDF, JPG or PNG files no larger than 10 MB each.",
  "membership-submission-open": "You already have a membership submission under review.",
  "membership-active-required": "Activate your membership by paying the 5% salary-based membership fee before using this service.",
  "membership-salary-required": "Enter a valid monthly salary in your profile before paying the membership fee.",
  "membership-payment-required": "A paid membership fee must be recorded before CSR can activate this member.",
  "membership-onboarding-approval-required": "CSR must approve your membership onboarding form before you can pay and activate membership.",
  "funeral-documents": "Upload the completed Funeral Policy Form before submitting the funeral cover application.",
  "funeral-additional-document": "Upload the Additional Member Funeral Form when adding dependants or extended family.",
  "subscription-create": "We could not create the membership subscription.",
  "membership-month-paid": "Payment for this month has already been processed.",
  "membership-payment-in-progress": "A payment session for this month is already in progress. Please try again shortly.",
  "membership-migration-required": "Membership payments need the latest database migration. Apply migration 011 in Supabase, then try again.",
